...
PATCHES+=(
	...
	"${FILESDIR}/${P}-musl-avoid-mallinfo.patch"
	"${FILESDIR}/${P}-musl-ifdef-nonstandard-includes.patch"
#	"${FILESDIR}/${P}-musl-link-libexecinfo.patch"

# patches from Alpine linux
	"${FILESDIR}/qt-musl-dispatch_to_musl.patch"
	"${FILESDIR}/qt-musl-execinfo.patch"
	"${FILESDIR}/qt-musl-siginfo_t.patch"
	"${FILESDIR}/qt-musl-stackstart.patch"
	"${FILESDIR}/qt-musl-resolve.patch"
	"${FILESDIR}/qt-musl-pvalloc.patch"
)
